...
beautiful.init(string.format("%s/.config/awesome/themes/myRice/theme.lua", os.getenv("HOME"))) 

-- beautiful.init(string.format("%s/.config/awesome/themes/%s/theme.lua"), os.getenv("HOME"), "myRice")
-- default theme in this config
...
-- keyoard layout cant be changed here
keyboard_layout = "us"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- no name of tag bcause powerline taglist has number in it
    ...
    local bg_color = "#0c365e"
    local border_color = "#eaeaea"
    -- new taglist
    ...
    -- stolen tasklist
    s.stolentasklist = awful.widget.tasklist {
        screen   = s,
    ...
    local space = wibox.widget.textbox(lain.util.markup.font("sans 12", "   "))
...
globalkeys = gears.table.join(
    awful.key({modkey,            }, "q", function() awful.spawn(browser) end,
              {description="opens web browser", group="client"}),
...
--]]
    ...
    awful.key({ modkey, "Control" }, "m", function () xrandr.xrandr()                        end,
              {description = "dual monitor settings", group = "settings"}),
...
--]]
	...
	{description = "switches keyboard layout"}),
    -- volume control
    awful.key({ altkey }, "Up", function() volumecfg:up() end),
    awful.key({ altkey }, "Down", function() volumecfg:down() end)
)
...
awful.rules.rules = {
    ...
    -- To enable titlebar set titlebar_enabled = true
