...
local keyboard_layout = require("components.keyboard-layout")
...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "m", 
        ...
        {description = "toggle monitors", group = "launcher"}
    ),
    -- Keyboard layout
    awful.key( { altkey }, "Shift_L", function () keyboard_layout.switch_layout() end),
    -- =========================================
    -- FUNCTION KEYS
    -- =========================================
